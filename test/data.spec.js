import {
  searcher, showInfo, orderBy, typeFilter, showInfoCalc, candyCalculator, showAllData,
} from '../src/data';
...
describe('searcher', () => {
  ...
  it('Retorna error', () => {
    expect(searcher(inputShow, 'bulbasur')).toEqual('El nombre ingresado no es correcto');
  });
});
